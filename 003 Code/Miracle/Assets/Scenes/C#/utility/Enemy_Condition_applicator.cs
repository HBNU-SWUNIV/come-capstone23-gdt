...
public class Enemy_Condition_applicator : MonoBehaviour
{
    ...
    public void Apply_state() 
    {
        switch (state)
        {
            case Enemy_State.burn://화상은 스테이터스에서 관리 
                ...
                break;
            case Enemy_State.deceleration://0==감속
